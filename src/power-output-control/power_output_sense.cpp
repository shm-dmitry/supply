...
#define POWER_OUTPUT_SENSE_VI_RL ((uint32_t)49500)

// i = readI * 5 * 1000 (gain) * (1/0.01) (1/rshunt) / 1024 * 1000 (A to mA) / 49500
#define POWER_OUTPUT_SENSE_VI_TO_I(value) (((((uint32_t)value) * POWER_OUTPUT_SENSE_V_OFFSET * POWER_OUTPUT_SENSE_VI_1_div_RSHUNT / POWER_OUTPUT_SENSE_1024) * POWER_OUTPUT_SENSE_MX_TO_X) / POWER_OUTPUT_SENSE_VI_RL);
